...
export default function ExcelUpload({ onImportData }) {
  ...
  const handleFileUpload = async (event) => {
    ...
    console.log('TGE ExcelUpload - file type:', file.constructor.name);
    console.log('TGE ExcelUpload - file size:', file.size);
    console.log('TGE ExcelUpload - file name:', file.name);
    ...
    try {
      console.log('TGE ExcelUpload - calling onImportData with file:', file);
